...
export var individualUpdate = {
  ...
  workflow: [{
    ...
    type: 'alert',
    next: {
      success: 'PBXyadt5nPWACgf'
    },
    nodename: 'Alert Failed to Update',
    title: 'Failed',
    ...
    type: 'validate',
    next: {
      success: 'PBX6KozNZ9Oas',
      failure: 'PBXS2WTfgXDTZ'
    },
    nodename: 'Validate',
    form_id: ''
  }, {
